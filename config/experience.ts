...
export const mission: LocalizedText = {
  ru: "19 лет в IT: от веб-разработки, управления отделами и сетевой инфраструктуры до Data Science, ML и AI. Внедряю нейросети, ML-модели и системы автоматизации, которые реально сокращают ручной труд и ускоряют процессы.\n\nЕсли вам нужен результат, который заметен в цифрах:\n✅ автоматизировать рутину и снять нагрузку с команды — сокращаю время обработки данных до 90%\n✅ внедрить AI для анализа заявок и клиентов — снижаю время принятия решений с дней до часов\n✅ настроить умного бота для продаж и поддержки — повышаю скорость ответа и не теряю горячие лиды\n✅ связать CRM, мессенджеры и таблицы в единую систему — убираю хаос и ручной перенос данных\n✅ запускать MVP быстро и без лишних затрат — довожу идею до рабочего решения за недели, а не месяцы",
  en: "19 years in IT: from web development, team leadership, and network infrastructure to Data Science, ML, and AI. I implement neural networks, ML models, and automation systems that meaningfully reduce manual work and accelerate operations.\n\nIf you need results visible in numbers:\n✅ automate routine work and reduce team workload - I cut data-processing time by up to 90%\n✅ implement AI for application and customer analysis - I reduce decision-making from days to hours\n✅ launch an intelligent sales/support bot - I increase response speed and prevent hot-lead loss\n✅ connect CRM, messengers, and spreadsheets into one system - I remove chaos and manual copy-paste\n✅ ship MVPs fast and cost-efficiently - I turn ideas into working solutions in weeks, not months",
};
